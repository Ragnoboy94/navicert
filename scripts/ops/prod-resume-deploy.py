...
if [ -d "$BK/data-snapshot" ]; then
  mkdir -p data
  for f in outreach-sent.json outreach-unsubscribed.json outreach-schedule.json outreach-queue.json outreach-certificates-sent.json outreach-certificates-schedule.json outreach-certificates-queue.json outreach-fsa-jobs.json fsa-token.json; do
